...
numprocs= data[:,0]
time = data[:,1]
gflops = 2. * 8000. * 8000. * 8000./(time*1000000000.)
...
ax.legend(loc="upper left",prop={'size':16})
fig.savefig("iv_rcc_speedup.pdf")
